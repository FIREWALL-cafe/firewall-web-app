...
function SearchCompare({ images, query, searchId, isLoading = false, isBanned = false }) {
  return (
    <section
    ...
    >
      <div className="flex overflow-hidden flex-col self-stretch my-auto max-w-[1280px] rounded-lg border border-red-600 border-solid min-w-[240px] w-full max-md:max-w-full">
        <ImageCarousel images={images} searchId={searchId} isLoading={isLoading} isBanned={isBanned} />
